...
const NavBar2: React.FC = () => {
  ...
  return (
    <motion.div className='fixed z-50 top-0 w-full bg-black' style={{ backgroundColor }}
    transition={{ duration : 0.5}}>
    <nav className={` text-white border-b-[0.1px] border-opacity-55 border-white bg-black flex justify-between h-[6rem] relative `}>
